# How to contribute to cozy-twakechat?
...
- What is the version of the cozy-twakechat app?
...
```
$ git clone github.com/cozy/cozy-twakechat.git
$ cd cozy-twakechat
$ git remote add fork git://github.com/yourusername/cozy-twakechat.git
```
...
Go to https://github.com/yourusername/cozy-twakechat and select your branch. Click the 'Pull Request' button and fill out the form.
...
The cozy-twakechat is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-twakechat/issues/new
...
[localization]: https://github.com/cozy/cozy-twakechat/blob/master/README.md#localization
